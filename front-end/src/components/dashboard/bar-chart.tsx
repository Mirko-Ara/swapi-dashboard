    ...
    return (
        <div className="w-full">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-2 mt-4">
                    ...
                    <>
                        {!allPagesFetched && genderData && currentPage < (genderData.totalPages || totalPages) && (
                            <button
                                ...
                                className="hover:scale-[0.98] active:scale-[0.98] font-semibold cursor-pointer inline-flex items-center justify-center rounded-xl border border-border bg-muted text-foreground text-sm px-4 py-2 shadow-sm hover:bg-muted/70 hover:text-emerald-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                disabled={isLoading || isFetching}
                            >
                                {t("fetchNextPage", {
                                    page: currentPage + 1,
                ...
                <button
                    onClick={handleResetData}
                    className="hover:scale-[0.98] active:scale-[0.98] text-foreground font-semibold cursor-pointer inline-flex items-center justify-center rounded-xl border border-border bg-muted/70 text-sm px-4 py-2 shadow-sm hover:bg-destructive/10 hover:text-destructive transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    disabled={(isLoading || isFetching)}
                >
