...
export const UserManagementPage = () => {
    ...
    const handleUpdateSuccess = useCallback(() => {
        toast.success(t('userUpdatedSuccessfully', { user: editingUser?.username || 'user'}));
        setEditingUser(null);
    }, [editingUser, t]);

    const handleCreateSuccess = useCallback(() => {
        toast.success(t('userCreateSuccessfully', {user: watch("username")}));
        reset();
    }, [reset, t, watch]);

    const createUserMutation = useCreateUser(handleCreateSuccess);
    ...
    useEffect(() => {
        if(editingUser) {
            ...
            console.log("Resetting form to create new user defaults.");
            setTimeout(() => reset({
                username: '',
                email: '',
                password: '',
    ...
    const onSubmit = async (data: UserFormData) => {
        ...
        try {
            ...
            toast.error(t('errorSavingUser', {user: userData.username}));
        }
    };
    ...
    console.log("Current isActive state from form (isUserActive):", isUserActive);
