                        ...
                        <TabsContent value="appearance">
                            <Card>
                                ...
                                <CardContent className="space-y-5">
                                    ...
                                    <div className="group relative flex items-center gap-5 p-4 rounded-xl border border-border/60 bg-gradient-to-r from-card/80 to-card/60 hover:from-accent/5 hover:to-accent/20 transition-all duration-300 shadow-md shadow-primary/10 hover:shadow-lg hover:shadow-primary/20">
                                        <div className="bg-green-500/15 text-green-500 p-2.5 rounded-full flex items-center justify-center">
